...
import { Send, Plus, Trash2, Bot, User, Loader2, Edit3, Settings, X, Check, Code, Eye, Globe, Brain, ChevronDown, BookOpen, Search, Download, Upload, AlertTriangle } from 'lucide-react';
