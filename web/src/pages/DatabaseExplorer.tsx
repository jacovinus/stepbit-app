...
import { Play, Table as TableIcon, Database, Info, Loader2, AlertCircle, ChevronLeft, ChevronRight, Search, Camera } from 'lucide-react';
    ...
    <div className="flex flex-col h-full bg-[#0a0a0a] text-zinc-100 p-6 gap-6 overflow-hidden">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 bg-zinc-800 hover:bg-zinc-700 disabled:opacity-50 rounded-xl font-semibold transition-all text-sm"
        >
